            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <main>
                    <div class="grid grid-cols-3 gap-4">
                        <div wire:ignore id="myBoard" class="col-span-2 rounded"></div>
                        ...
                        <div class="text-[#C3C3C2] bg-[#262522] overflow-hidden p-[10px] rounded-md">    
                            ...
                            {{-- <span>List variation and turn move</span> --}}
                            ...
                            <div>
                                @livewire('stockfish-component', ['toggleFlip' => $toggleFlip])
                            </div>


                            <hr class="py-1 mt-1" style="border-top: 1px solid #3C3B39" />
                            ...
                            <div class="buttons w-[100%] overflow-hidden">
                                ...
                                <div class="w-[50%] text-center float-left">
                                    <button wire:click="toggleClick" class="w-[99%] bg-[#3C3B39] hover:bg-[#454341] text-[#C3C3C2] font-bold py-2 rounded" id="btnflip">
                                        <div style="margin:0 auto" class="w-[133px] display-block">
